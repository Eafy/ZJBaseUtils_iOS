...
typedef enum {
	/** No error. */
	ZJSSKeychainErrorNone = noErr,
	
	/** Some of the arguments were invalid. */
	ZJSSKeychainErrorBadArguments = -1001,
	
	/** There was no password. */
	ZJSSKeychainErrorNoPassword = -1002,
	
	/** One or more parameters passed internally were not valid. */
	ZJSSKeychainErrorInvalidParameter = errSecParam,
	
	/** Failed to allocate memory. */
	ZJSSKeychainErrorFailedToAllocated = errSecAllocate,
	
	/** No trust results are available. */
	ZJSSKeychainErrorNotAvailable = errSecNotAvailable,
	
	/** Authorization/Authentication failed. */
	ZJSSKeychainErrorAuthorizationFailed = errSecAuthFailed,
	
	/** The item already exists. */
	ZJSSKeychainErrorDuplicatedItem = errSecDuplicateItem,
	
	/** The item cannot be found.*/
	ZJSSKeychainErrorNotFound = errSecItemNotFound,
	
	/** Interaction with the Security Server is not allowed. */
	ZJSSKeychainErrorInteractionNotAllowed = errSecInteractionNotAllowed,
	
	/** Unable to decode the provided data. */
	ZJSSKeychainErrorFailedToDecode = errSecDecode
} ZJSSKeychainErrorCode;

extern NSString *const kZJSSKeychainErrorDomain;

/** Account name. */
extern NSString *const kZJSSKeychainAccountKey;
 ...
 */
extern NSString *const kZJSSKeychainCreatedAtKey;

/** Item class. */
extern NSString *const kZJSSKeychainClassKey;

/** Item description. */
extern NSString *const kZJSSKeychainDescriptionKey;

/** Item label. */
extern NSString *const kZJSSKeychainLabelKey;

/** Time the item was last modified.
 
 The value will be a string.
 */
extern NSString *const kZJSSKeychainLastModifiedKey;

/** Where the item was created. */
extern NSString *const kZJSSKeychainWhereKey;
 ...
 */
@interface ZJSAMKeychain : NSObject
