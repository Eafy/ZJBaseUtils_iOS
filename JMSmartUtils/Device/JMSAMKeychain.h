...
typedef enum {
	/** No error. */
	JMSSKeychainErrorNone = noErr,
	
	/** Some of the arguments were invalid. */
	JMSSKeychainErrorBadArguments = -1001,
	
	/** There was no password. */
	JMSSKeychainErrorNoPassword = -1002,
	
	/** One or more parameters passed internally were not valid. */
	JMSSKeychainErrorInvalidParameter = errSecParam,
	
	/** Failed to allocate memory. */
	JMSSKeychainErrorFailedToAllocated = errSecAllocate,
	
	/** No trust results are available. */
	JMSSKeychainErrorNotAvailable = errSecNotAvailable,
	
	/** Authorization/Authentication failed. */
	JMSSKeychainErrorAuthorizationFailed = errSecAuthFailed,
	
	/** The item already exists. */
	JMSSKeychainErrorDuplicatedItem = errSecDuplicateItem,
	
	/** The item cannot be found.*/
	JMSSKeychainErrorNotFound = errSecItemNotFound,
	
	/** Interaction with the Security Server is not allowed. */
	JMSSKeychainErrorInteractionNotAllowed = errSecInteractionNotAllowed,
	
	/** Unable to decode the provided data. */
	JMSSKeychainErrorFailedToDecode = errSecDecode
} JMSSKeychainErrorCode;

extern NSString *const kJMSSKeychainErrorDomain;

/** Account name. */
extern NSString *const kJMSSKeychainAccountKey;
 ...
 */
extern NSString *const kJMSSKeychainCreatedAtKey;

/** Item class. */
extern NSString *const kJMSSKeychainClassKey;

/** Item description. */
extern NSString *const kJMSSKeychainDescriptionKey;

/** Item label. */
extern NSString *const kJMSSKeychainLabelKey;

/** Time the item was last modified.
 
 The value will be a string.
 */
extern NSString *const kJMSSKeychainLastModifiedKey;

/** Where the item was created. */
extern NSString *const kJMSSKeychainWhereKey;
 ...
 */
@interface JMSAMKeychain : NSObject
